...
<br>
<div align='center'><i class='material-icons'>info</i> Deseja mesmo excluir este poeta?</div><br>
<br>
<div>
<a href="?titulo=Excluir+Autor&page=resultado.php&excluir=autor&id=<?php echo $_GET["id"]; ?>">
